...
<template>
    <fieldset>
        <legend>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" width="20" height="20" lang="en">
        ...
        <div class="buttons-group">
            <label>
                <input type="radio" name="locale" v-model="selectedLang" value="pl" />
                <span>🇵🇱 PL</span>
            </label>
            <label>
                <input type="radio" name="locale" v-model="selectedLang" value="en" />
                <span>🇬🇧 EN</span>
            </label>
            <label>
                <input type="radio" name="locale" v-model="selectedLang" value="uk" />
                <span>🇺🇦 UA</span>
            </label>
        </div>
    </fieldset>
