...
// import '../fonts/TeXGyreTermes-bolditalic'
...
export default answers => {
    ...
    doc.text([normalize(answers[2].a_3), 'Wydział Cywilny'], 140, 10)

    doc.setFont('TeXGyreTermes', 'normal', 'bold')
    doc.text({K: 'Wnioskodawczyni:', M: 'Wnioskodawca:'}[answers[0].a_0] || '', 140, 25)

    doc.setFont('TeXGyreTermes', 'normal', 'normal')
    doc.text([
        normalize(answers[2].a_5+' '+ answers[2].a_6),
        normalize(answers[2].a_1),
        normalize(answers[2].a_0),
        normalize(answers[2].a_4 ? answers[2].a_4_0 : ''),
        normalize(answers[2].a_4 ? answers[2].a_4_1 : ''),
    ], 140, 30)
    ...
    doc.text([
        ...
        '',
        '1.   sprostowanie aktu urodzenia Wnioskodawcy zarejestrowanego w Urzędzie Stanu Cywilnego w '+ normalize(answers[2].a_9) +' za nr  '+ normalize(answers[2].a_8) +', w ten sposób, żeby: ',
        {
        ...
        ...(answers[0].a_1 ? ['b.           imię '+normalize(answers[2].a_5)+' zostało zmienione na '+normalize(answers[0].a_1_0)+';'] : []),
        ...(answers[0].a_2 ? ['c.       nazwisko '+normalize(answers[2].a_6)+' zostało zmienione na '+normalize(answers[0].a_2_0)+'; '] : []),
